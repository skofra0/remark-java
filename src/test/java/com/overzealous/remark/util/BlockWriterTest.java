...
public class BlockWriterTest {
  ...
  public void testWriteNestedBlocks() throws Exception {
    ...
    Assert.assertEquals("hello\n\nworld",TestUtils.normalize( bw.toStringNormalize()));
  }
